...
struct Onboarding2: View {
    ...
    func navigateToNextPage() {
            ...
            let onboarding3View = Onboarding3().environmentObject(themeManager)
...
struct Onboarding2_Previews: PreviewProvider {
    static var previews: some View {
        Onboarding2().environmentObject(ThemeManager()) // Provide the theme manager
    }
}
#endif
