...
struct AccountVerification4: View {
    ...
    var body: some View {
        VStack {
            ...
            Button(action: {
                ...
                navigateToAccountVerify3(themeManager: themeManager)
            }) {
                Text("Next")
...
#if DEBUG
struct AccountVerification4_Previews: PreviewProvider {
    static var previews: some View {
        AccountVerification4().environmentObject(ThemeManager()) // Provide the theme manager
    }
}
#endif
