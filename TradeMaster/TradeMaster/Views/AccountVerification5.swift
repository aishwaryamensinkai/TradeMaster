...
struct AccountVerification5: View {
...
#if DEBUG
struct AccountVerification5_Previews: PreviewProvider {
    static var previews: some View {
        AccountVerification5().environmentObject(ThemeManager()) // Provide the theme manager
    }
}
#endif
